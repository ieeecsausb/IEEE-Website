            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24" ref={containerRef}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[1, 2, 3, 4, 5, 6].map((project) => (
                        <div key={project} className="group bg-white dark:bg-ieee-dark-card rounded-2xl shadow-lg hover:shadow-2xl transition-[transform,box-shadow] duration-300 transform hover:-translate-y-2 overflow-hidden border border-gray-100 dark:border-orange-900/20">
